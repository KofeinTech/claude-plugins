...
**Development panel:** The PR automatically appears in the ticket's Development
section because the branch name contains the ticket key. This is handled by the
GitHub for Jira integration app -- no manual linking needed.
